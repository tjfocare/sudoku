...
class TestIsEmpty(unittest.TestCase):
    ...
    def setUp(self):
        self.board = Board(copy.deepcopy(grid))

    def test_is_empty_top_left(self):
        self.assertTrue(board.is_editable(0, 0))

    def test_is_empty_top_middle(self):
        self.assertTrue(board.is_editable(0, 5))

    def test_is_empty_top_right(self):
        self.assertTrue(board.is_editable(0, 8))

    def test_is_empty_boardttom_right(self):
        self.assertTrue(board.is_editable(8, 8))
...
class TestFindNextEmpty(unittest.TestCase):
    ...
    def test_empty_after_sequence(self):
        # print_board(self.board)
        self.board.set_cell(4, 0, 0)
        # print_board(self.board)
        self.board.set_cell(7, 0, 1)
        # print_board(self.board)
        self.assertEqual(find_next_empty(self.board), (0, 3))

    # def test_is_not_empty_top_left(self):
    #     self.assertFalse(is_valid_placement(self.board, 8, 0, 0))
